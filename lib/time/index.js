...
const { isExpiringSoon, dateDiff, getLatest, PRIMARY_POLICY } = require('../util');
...
function supportedRanges(_origin, upgradeBudget = PRIMARY_POLICY) {
 ...
 */
function deprecationDates(_release, upgradeBudget = PRIMARY_POLICY) {
